...
public class MusicView extends FlexLayout {
    ...
    /*      New     */
    public MusicView(ArticlesApi articlesApi, ObjectFactory<ArticlePreviewComponent> articlePreviewObjectFactory, ObjectFactory<NameDayWidgetComponent> nameDayWidgetComponentObjectFactory) {
